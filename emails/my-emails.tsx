    ...
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Success isn’t built overnight—it’s the result of small, consistent
            efforts over time. Whether it&apos;s coding, writing, or any other
            pursuit, showing up every day, even when motivation fades, is what
            sets you apart. Stay consistent, keep improving, and watch how far
            you’ll go! Keep pushing forward!
          </Text>
